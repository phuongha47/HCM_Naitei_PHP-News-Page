...
<li class="nav-item">
    ...
    <div id="collapseUser" class="collapse" aria-labelledby="headingUser" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href={{ route('admin.add_user') }}>
            ...
            <a class="collapse-item" href={{ route('admin.search_user') }}>
...
<li class="nav-item">
    ...
    <div id="collapseCategory" class="collapse" aria-labelledby="headingCategory"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href={{ route('admin.add_category') }}>
            ...
            <a class="collapse-item" href= {{ route('admin.search_category') }}>
...
<li class="nav-item">
    ...
    <div id="collapsePost" class="collapse" aria-labelledby="headingPost"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href={{ route('admin.add_post') }}>
            ...
            <a class="collapse-item" href={{ route('admin.search_post') }}>
